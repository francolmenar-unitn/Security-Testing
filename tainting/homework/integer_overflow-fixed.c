...
int main() {
    ...
    int insurance = 1200;
    if (item_choice == 3) {
        // 1500 * item_quantity + insurance < INT_MAX
        // 1500 * item_quantity < INT_MAX - insurance
        // 1500 < (INT_MAX - insurance) / item_quantity
        if (1500 < (INT_MAX - insurance) / item_quantity) {
            if (a < INT_MAX / b)
        ...
        if (item_quantity > 3) {
         ...
         // 1000 * item_quantity< INT_MAX
         // 1000 < INT_MAX / item_quantity
        if (1000 < (INT_MAX / item_quantity) {
